...
class Layout1d extends Layout1dBase {
    ...
    _scrollIfNeeded() {
        ...
        if (this._scrollPosition === this._getItemPosition(this._scrollToIndex)[this._positionDim]) {
            console.log('uggggggghhhh', this._physicalItems.has(this._scrollToIndex));
            this._scrollToIndex = -1;
        }
    }
}
