            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  _context2.next = 9;
                  return module.import('./event-target-shim-40398015.js');
      ...
      var ContactCard = /*#__PURE__*/function (_LitElement) {
        ...
        _createClass(ContactCard, [{
          ...
          value: function render() {
            ...
            return html(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["<details style=\"background:", "\"><summary @click=\"", "\">", "</summary><p style=\"", "\">", "</p></details>"])), color, this._handleSummaryClick, name, styleMap(this._summaryStyle()), mediumText);
          }
        }, {
          key: "_summaryStyle",
          ...
          key: "styles",
          get: function get() {
            return css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral([":host{display:block;width:100%;margin:.25em 0}details,div{padding:1em;color:#fff;display:block}"])));
          }
        }]);
      ...
      var ContactList = /*#__PURE__*/function (_LitElement2) {
        ...
        _createClass(ContactList, [{
          ...
          value: function _renderContact(contact) {
            return html(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<contact-card .contact=\"", "\"></contact-card>"])), contact);
          }
        }, {
          key: "render",
          value: function render() {
            return html(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["<lit-virtualizer .layout=\"", "\" .items=\"", "\" .renderItem=\"", "\"></lit-virtualizer>"])), Layout1d, this.data, this._renderContact);
          }
        }], [{
          key: "properties",
          get: function get() {
          ...
          key: "styles",
          get: function get() {
            return css(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral([":host{display:block;position:absolute;top:0;right:0;bottom:0;left:0}lit-virtualizer{height:100%}"])));
          }
        }]);
