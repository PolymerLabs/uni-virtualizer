  ...
  return {
    execute: function () {
      ...
      var s$1 = function s(t) {
        ...
        var r = s.reduce(function (e, s, o) {
          return e + function (t) {
            if (t instanceof n$1) return t.cssText;
            if ("number" == typeof t) return t;
            throw Error("Value passed to 'css' function must be a 'css' function result: ".concat(t, ". Use 'unsafeCSS' to pass non-literal values, but\n            take care to ensure page security."));
          }(s) + t[o + 1];
        }, t[0]);
        var i = o$1.get(r);
        ...
        _createClass(a, [{
          ...
          value: function Πj(t, i) {
            ...
            if (void 0 !== r && !0 === s.reflect) {
              var _n = (null !== (h = null === (e = s.converter) || void 0 === e ? void 0 : e.toAttribute) && void 0 !== h ? h : o$2.toAttribute)(i, s.type);
          ...
          value: function K(t, i) {
            ...
            if (void 0 !== n && this.Πh !== n) {
              var _t = r.getPropertyOptions(n),
                  _l = _t.converter,
                  _a2 = null !== (h = null !== (e = null === (s = _l) || void 0 === s ? void 0 : s.fromAttribute) && void 0 !== e ? e : "function" == typeof _l ? _l : null) && void 0 !== h ? h : o$2.fromAttribute;
      ...
      var i$4 = i$3( /*#__PURE__*/function (_r) {
        _inherits(_class, _r);
        ...
        function _class(t) {
          ...
          var e;
          if (_this = _super.call(this, t), t.type !== t$2.ATTRIBUTE || "style" !== t.name || (null === (e = t.strings) || void 0 === e ? void 0 : e.length) > 2) throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.");
      ...
      var o$4 = globalThis.trustedTypes,
          l$3 = o$4 ? o$4.createPolicy("lit-html", {
        createHTML: function createHTML(t) {
          return t;
        }
      }) : void 0,
        ...
        for (var _i = 0; _i < s; _i++) {
          ...
          h += u === f$1 ? _s + r$3 : _d >= 0 ? (e.push(_l), _s.slice(0, _d) + "$lit$" + _s.slice(_d) + n$4 + _a) : _s + n$4 + (-2 === _d ? (e.push(void 0), _i) : _a);
        }
          ...
          for (; null !== (e = E$1.nextNode()) && d.length < u;) {
            if (1 === e.nodeType) {
              ...
              if (y$1.test(e.tagName)) {
                ...
                if (_i7 > 0) {
                  e.textContent = o$4 ? o$4.emptyScript : "";
      ...
      null === (i$5 = (t$3 = globalThis).litHtmlPlatformSupport) || void 0 === i$5 || i$5.call(t$3, N$1, C$1), (null !== (s$5 = (e$3 = globalThis).litHtmlVersions) && void 0 !== s$5 ? s$5 : e$3.litHtmlVersions = []).push("2.0.0-rc.2");
       ...
       * SPDX-License-Identifier: BSD-3-Clause
       */
      var t$4 = window.ShadowRoot && (void 0 === window.ShadyCSS || window.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
          e$4 = Symbol();
      ...
      var n$5 = /*#__PURE__*/function () {
        ...
        _createClass(n, [{
          key: "styleSheet",
          get: function get() {
            return t$4 && void 0 === this.t && (this.t = new CSSStyleSheet(), this.t.replaceSync(this.cssText)), this.t;
          }
        }, {
          key: "toString",
          value: function toString() {
      ...
      var s$6 = function s(t) {
        return new n$5(t + "", e$4);
      },
          i$6 = function i(e, n) {
        t$4 ? e.adoptedStyleSheets = n.map(function (t) {
          return t instanceof CSSStyleSheet ? t : t.styleSheet;
        }) : n.forEach(function (t) {
          var n = document.createElement("style");
          n.textContent = t.cssText, e.appendChild(n);
      ...
      var a$4 = /*#__PURE__*/function (_HTMLElement) {
        ...
        _createClass(a, [{
          ...
          value: function Πj(t, i) {
            ...
            if (void 0 !== r && !0 === s.reflect) {
              var _n = (null !== (h = null === (e = s.converter) || void 0 === e ? void 0 : e.toAttribute) && void 0 !== h ? h : o$5.toAttribute)(i, s.type);
          ...
          value: function K(t, i) {
            ...
            if (void 0 !== n && this.Πh !== n) {
              var _t = r.getPropertyOptions(n),
                  _l = _t.converter,
                  _a2 = null !== (h = null !== (e = null === (s = _l) || void 0 === s ? void 0 : s.fromAttribute) && void 0 !== e ? e : "function" == typeof _l ? _l : null) && void 0 !== h ? h : o$5.fromAttribute;
      ...
      a$4.finalized = !0, a$4.shadowRootOptions = {
        mode: "open"
      }, null === (e$5 = (s$7 = globalThis).reactiveElementPlatformSupport) || void 0 === e$5 || e$5.call(s$7, {
        ReactiveElement: a$4
      }), (null !== (h$4 = (r$4 = globalThis).reactiveElementVersions) && void 0 !== h$4 ? h$4 : r$4.reactiveElementVersions = []).push("1.0.0-rc.1");
      ...
      var i$7, l$5, o$6, s$8, n$7, a$5;
      (null !== (i$7 = (a$5 = globalThis).litElementVersions) && void 0 !== i$7 ? i$7 : a$5.litElementVersions = []).push("3.0.0-rc.1");
      ...
      h$5.finalized = !0, h$5._$litElement$ = !0, null === (o$6 = (l$5 = globalThis).litElementHydrateSupport) || void 0 === o$6 || o$6.call(l$5, {
        LitElement: h$5
      }), null === (n$7 = (s$8 = globalThis).litElementPlatformSupport) || void 0 === n$7 || n$7.call(s$8, {
        LitElement: h$5
      });
      ...
      var t$6 = Z.et,
        ...
        return o.I(t, i), o;
          ...
          s$a = {},
          f$2 = function f(o) {
        var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : s$a;
        return o.H = t;
      },
          a$6 = function a(o) {
        return o.H;
      ...
      function n$8(i) {
        void 0 !== this.N ? (o$7(this), this.M = i, h$6(this)) : this.M = i;
      }
      ...
      function l$6(i) {
        ...
        if (void 0 !== h && 0 !== h.size) if (t) {
          if (Array.isArray(e)) for (var _i2 = s; _i2 < e.length; _i2++) {
            r$5(e[_i2], !1), o$7(e[_i2]);
          } else null != e && (r$5(e, !1), o$7(e));
        } else r$5(this, i);
      }

      var d$3 = function d(i) {
        var t, e, r, o;
        i.type == t$5.CHILD && (null !== (t = (r = i).P) && void 0 !== t || (r.P = l$6), null !== (e = (o = i).Q) && void 0 !== e || (o.Q = n$8));
      };
      ...
      var c$3 = /*#__PURE__*/function (_t2) {
        ...
        _createClass(c, [{
          ...
          value: function O(i) {
            ...
            this.at(i), t && (r$5(this, i), o$7(this));
          }
        }, {
          key: "at",
          value: function at(t) {
      ...
      var u$1 = function u(e, s, t) {
        ...
        function _class(e) {
          ...
          if (_this = _super.call(this, e), e.type !== t$5.CHILD) throw Error("repeat() can only be used in text expressions");
          return _possibleConstructorReturn(_this);
        }
      ...
      var scroll = i$8(ScrollDirective);
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  _context2.next = 9;
                  return module.import('./event-target-shim-305b5338.js');
      ...
      var ContactCard = /*#__PURE__*/function (_LitElement) {
        _inherits(ContactCard, _LitElement);
        ...
        function ContactCard() {
          ...
          _this.open = false;
          _this._details = 'HTMLDetailsElement' in window;
          return _this;
        }
        ...
        _createClass(ContactCard, [{
          key: "render",
          value: function render() {
            var _ref = this.contact || {},
                mediumText = _ref.mediumText,
                color = _ref.color,
                name = _ref.name;

            return T(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["<details style=\"background:", "\"><summary @click=\"", "\">", "</summary><p style=\"", "\">", "</p></details>"])), color, this._handleSummaryClick, name, i$4(this._summaryStyle()), mediumText);
          }
        }, {
          key: "_summaryStyle",
          value: function _summaryStyle() {
            return !this._details && !this.open ? {
              display: 'none'
            } : {
              display: 'block'
            };
          ...
          key: "_handleSummaryClick",
          value: function _handleSummaryClick() {
            if (!this._details) {
              this.open = !this.open;
            }
          }
          ...
          key: "styles",
          get: function get() {
            return r$1(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral([":host{display:block;width:100%;margin:.25em 0}details,div{padding:1em;color:#fff;display:block}"])));
          }
        }]);
      ...
      var ContactList = /*#__PURE__*/function (_LitElement2) {
        _inherits(ContactList, _LitElement2);

        var _super2 = _createSuper(ContactList);
        ...
        _createClass(ContactList, [{
          ...
          key: "_renderContact",
          value: function _renderContact(contact) {
            return T(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<contact-card .contact=\"", "\"></contact-card>"])), contact);
          }
        }, {
          key: "render",
          value: function render() {
            return T(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["<lit-virtualizer .layout=\"", "\" .items=\"", "\" .renderItem=\"", "\"></lit-virtualizer>"])), Layout1d, this.data, this._renderContact);
          }
        }], [{
          key: "properties",
          get: function get() {
          ...
          key: "styles",
          get: function get() {
            return r$1(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral([":host{display:block;position:absolute;top:0;right:0;bottom:0;left:0}lit-virtualizer{height:100%}"])));
          }
        }]);
