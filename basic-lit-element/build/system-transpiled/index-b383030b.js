System.register(['lit', 'lit/directives/style-map'], function (exports, module) {
  'use strict';
  var css, html$1, LitElement$1, styleMap;
  return {
    setters: [function (module) {
      css = module.css;
      html$1 = module.html;
      LitElement$1 = module.LitElement;
    }, function (module) {
      styleMap = module.styleMap;
    }],
    execute: function () {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  _context2.next = 9;
                  return module.import('./event-target-shim-90df536a.js');
      ...
      var ContactCard = /*#__PURE__*/function (_LitElement) {
        ...
        _createClass(ContactCard, [{
          ...
          value: function render() {
            ...
            return html$1(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["<details style=\"background:", "\"><summary @click=\"", "\">", "</summary><p style=\"", "\">", "</p></details>"])), color, this._handleSummaryClick, name, styleMap(this._summaryStyle()), mediumText);
          }
        }, {
          key: "_summaryStyle",
      ...
      var ContactList = /*#__PURE__*/function (_LitElement2) {
        ...
        _createClass(ContactList, [{
          ...
          value: function _renderContact(contact) {
            return html$1(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<contact-card .contact=\"", "\"></contact-card>"])), contact);
          }
        }, {
          key: "render",
          value: function render() {
            return html$1(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["<lit-virtualizer .layout=\"", "\" .items=\"", "\" .renderItem=\"", "\"></lit-virtualizer>"])), Layout1d, this.data, this._renderContact);
          }
        }], [{
          key: "properties",
          get: function get() {
