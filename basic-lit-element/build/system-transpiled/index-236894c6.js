    ...
    execute: function () {
      ...
      var n = /*#__PURE__*/function () {
        function n(t, _n) {
          ...
          if (_n !== e) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
          this.cssText = t;
        }
      ...
      var s = function s(t) {
        ...
        var i = o.get(r);
        return void 0 === i && o.set(r, i = new n(r, e)), i;
      },
          i = function i(e, n) {
      ...
      a.finalized = !0, a.shadowRootOptions = {
        ...
        ReactiveElement: a
      }), (null !== (h = (r$1 = globalThis).reactiveElementVersions) && void 0 !== h ? h : r$1.reactiveElementVersions = []).push("1.0.0-rc.1");
      ...
      var o$2 = globalThis.trustedTypes,
        ...
        for (var _i = 0; _i < s; _i++) {
          ...
          h += u === f ? _s + r$2 : _d >= 0 ? (e.push(_l), _s.slice(0, _d) + "$lit$" + _s.slice(_d) + n$2 + _a) : _s + n$2 + (-2 === _d ? (e.push(void 0), _i) : _a);
        }
        ...
        function N(_ref, s) {
          ...
          for (; null !== (e = E.nextNode()) && d.length < u;) {
            if (1 === e.nodeType) {
              if (e.hasAttributes()) {
                ...
                try {
                  for (_iterator.s(); !(_step = _iterator.n()).done;) {
                    ...
                    if (_i5.endsWith("$lit$") || _i5.startsWith(n$2)) {
                      var _s2 = a[r++];

                      if (_t3.push(_i5), void 0 !== _s2) {
                        var _t5 = e.getAttribute(_s2.toLowerCase() + "$lit$").split(n$2),
                            _i6 = /([.?@])?(.*)/.exec(_s2);
              ...
              if (y.test(e.tagName)) {
                var _t6 = e.textContent.split(n$2),
                    _i7 = _t6.length - 1;
              ...
              for (; -1 !== (_t7 = e.data.indexOf(n$2, _t7 + 1));) {
                d.push({
                  type: 7,
                  index: l
                }), _t7 += n$2.length - 1;
          ...
          value: function I(t) {
            ...
            if (void 0 === o) t = S$1(this, t, i, 0), l = !d(t) || t !== this.H && t !== w, l && (this.H = t);else {
              ...
              for (t = o[0], _n = 0; _n < o.length - 1; _n++) {
                _h = S$1(this, _e[s + _n], i, _n), _h === w && (_h = this.H[_n]), l || (l = !d(_h) || _h !== this.H[_n]), _h === A ? t = A : t !== A && (t += (null != _h ? _h : "") + o[_n + 1]), this.H[_n] = _h;
              }
            }
            l && !e && this.W(t);
          }
      ...
      null === (i$1 = (t$1 = globalThis).litHtmlPlatformSupport) || void 0 === i$1 || i$1.call(t$1, N, C), (null !== (s$2 = (e$2 = globalThis).litHtmlVersions) && void 0 !== s$2 ? s$2 : e$2.litHtmlVersions = []).push("2.0.0-rc.2");
      ...
      var i$5 = i$4( /*#__PURE__*/function (_r) {
        _inherits(_class, _r);
      ...
      var t$3 = Z.et,
        ...
        if (void 0 === n) {
          var _i = l.insertBefore(e$4(), r),
              _v = l.insertBefore(e$4(), r);
      ...
      function n$5(i) {
        void 0 !== this.N ? (o$4(this), this.M = i, h$3(this)) : this.M = i;
      }
      ...
      function l$3(i) {
        ...
        if (void 0 !== h && 0 !== h.size) if (t) {
          if (Array.isArray(e)) for (var _i2 = s; _i2 < e.length; _i2++) {
            r$3(e[_i2], !1), o$4(e[_i2]);
          } else null != e && (r$3(e, !1), o$4(e));
        } else r$3(this, i);
      }

      var d$2 = function d(i) {
        var t, e, r, o;
        i.type == t$2.CHILD && (null !== (t = (r = i).P) && void 0 !== t || (r.P = l$3), null !== (e = (o = i).Q) && void 0 !== e || (o.Q = n$5));
      };
      ...
      var c$2 = /*#__PURE__*/function (_t2) {
        ...
        _createClass(c, [{
          ...
          value: function O(i) {
            ...
            this.at(i), t && (r$3(this, i), o$4(this));
          }
        }, {
          key: "at",
          value: function at(t) {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 11:
                  ...
                  _RO = module.import('resize-observer-polyfill');
                  _context2.next = 16;
                  return _RO;
      ...
      var scroll = i$4(ScrollDirective);
      ...
      __decorate([e$3()], LitVirtualizer.prototype, "renderItem", void 0);
      ...
      __decorate([e$3()], LitVirtualizer.prototype, "keyFunction", void 0);

      __decorate([e$3({
        attribute: false
      })], LitVirtualizer.prototype, "layout", null);

      LitVirtualizer = __decorate([n$4('lit-virtualizer')], LitVirtualizer);
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  _context2.next = 9;
                  return module.import('./event-target-shim-65227db9.js');
      ...
      var ContactCard = /*#__PURE__*/function (_LitElement) {
        ...
        _createClass(ContactCard, [{
          ...
          value: function render() {
            ...
            return T(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["<details style=\"background:", "\"><summary @click=\"", "\">", "</summary><p style=\"", "\">", "</p></details>"])), color, this._handleSummaryClick, name, i$5(this._summaryStyle()), mediumText);
          }
        }, {
          key: "_summaryStyle",
          ...
          key: "styles",
          get: function get() {
            return r(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral([":host{display:block;width:100%;margin:.25em 0}details,div{padding:1em;color:#fff;display:block}"])));
          }
        }]);
      ...
      var ContactList = /*#__PURE__*/function (_LitElement2) {
        ...
        _createClass(ContactList, [{
          ...
          key: "styles",
          get: function get() {
            return r(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral([":host{display:block;position:absolute;top:0;right:0;bottom:0;left:0}lit-virtualizer{height:100%}"])));
          }
        }]);
