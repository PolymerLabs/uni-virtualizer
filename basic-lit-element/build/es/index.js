 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t$2={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},i$3=t=>(...i)=>({_$litDirective$:t,values:i});class s$4{constructor(t){}T(t,i,s){this.Σdt=t,this.M=i,this.Σct=s;}S(t,i){return this.update(t,i)}update(t,i){return this.render(...i)}}//# sourceMappingURL=directive.js.map

/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const i$4=i$3(class extends s$4{constructor(t){var e;if(super(t),t.type!==t$2.ATTRIBUTE||"style"!==t.name||(null===(e=t.strings)||void 0===e?void 0:e.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce(((e,r)=>{const s=t[r];return null==s?e:e+`${r=r.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${s};`}),"")}update(e,[r]){const{style:s}=e.element;if(void 0===this.St){this.St=new Set;for(const t in r)this.St.add(t);return this.render(r)}this.St.forEach((t=>{null==r[t]&&(this.St.delete(t),t.includes("-")?s.removeProperty(t):s[t]="");}));for(const t in r){const e=r[t];null!=e&&(this.St.add(t),t.includes("-")?s.setProperty(t,e):s[t]=e);}return w}});//# sourceMappingURL=style-map.js.map

/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const {et:t$3}=Z,d$1=o=>void 0===o.strings,e$3=()=>document.createComment(""),u$1=(o,i,n)=>{var v;const l=o.A.parentNode,r=void 0===i?o.B:i.A;if(void 0===n){const i=l.insertBefore(e$3(),r),v=l.insertBefore(e$3(),r);n=new t$3(i,v,o,o.options);}else {const t=n.B.nextSibling,i=n.M!==o;if(i&&(null===(v=n.Q)||void 0===v||v.call(n,o),n.M=o),t!==r||i){let o=n.A;for(;o!==t;){const t=o.nextSibling;l.insertBefore(o,r),o=t;}}}return n},c$1=(o,t,i=o)=>(o.I(t,i),o),s$5={},f$1=(o,t=s$5)=>o.H=t,a$3=o=>o.H,m$1=o=>{var t;null===(t=o.P)||void 0===t||t.call(o,!1,!0);let i=o.A;const n=o.B.nextSibling;for(;i!==n;){const o=i.nextSibling;i.remove(),i=o;}};//# sourceMappingURL=directive-helpers.js.map

/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const r$3=(i,t)=>{var s,e;const o=i.N;if(void 0===o)return !1;for(const i of o)null===(e=(s=i).O)||void 0===e||e.call(s,t,!1),r$3(i,t);return !0},o$4=i=>{let t,s;do{if(void 0===(t=i.M))break;s=t.N,s.delete(i),i=t;}while(0===(null==s?void 0:s.size))},h$3=i=>{for(let t;t=i.M;i=t){let s=t.N;if(void 0===s)t.N=s=new Set;else if(s.has(i))break;s.add(i),d$2(t);}};function n$4(i){void 0!==this.N?(o$4(this),this.M=i,h$3(this)):this.M=i;}function l$3(i,t=!1,s=0){const e=this.H,h=this.N;if(void 0!==h&&0!==h.size)if(t)if(Array.isArray(e))for(let i=s;i<e.length;i++)r$3(e[i],!1),o$4(e[i]);else null!=e&&(r$3(e,!1),o$4(e));else r$3(this,i);}const d$2=i=>{var t,e,r,o;i.type==t$2.CHILD&&(null!==(t=(r=i).P)&&void 0!==t||(r.P=l$3),null!==(e=(o=i).Q)&&void 0!==e||(o.Q=n$4));};class c$2 extends s$4{constructor(){super(...arguments),this.isConnected=!0,this.ut=w,this.N=void 0;}T(i,t,s){super.T(i,t,s),h$3(this);}O(i,t=!0){this.at(i),t&&(r$3(this,i),o$4(this));}at(t){var s,e;t!==this.isConnected&&(t?(this.isConnected=!0,this.ut!==w&&(this.setValue(this.ut),this.ut=w),null===(s=this.reconnected)||void 0===s||s.call(this)):(this.isConnected=!1,null===(e=this.disconnected)||void 0===e||e.call(this)));}S(i,t){if(!this.isConnected)throw Error(`AsyncDirective ${this.constructor.name} was rendered while its tree was disconnected.`);return super.S(i,t)}setValue(i){if(this.isConnected)if(d$1(this.Σdt))this.Σdt.I(i,this);else {const t=[...this.Σdt.H];t[this.Σct]=i,this.Σdt.I(t,this,0);}else this.ut=i;}disconnected(){}reconnected(){}}//# sourceMappingURL=async-directive.js.map
...
async function init() {
    if (_RO) {
        ...
        try {
            ...
            _RO = import('./ResizeObserver.es-e5f534cd.js');
...
async function init$1() {
    ...
    try {
        ...
        _ET = (await import('./event-target-shim-eb319d61.js')).EventTarget;
    }
    return (ET = _ET);
}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const n$5=n=>e=>"function"==typeof e?((n,e)=>(window.customElements.define(n,e),e))(n,e):((n,e)=>{const{kind:t,elements:i}=e;return {kind:t,elements:i,finisher(e){window.customElements.define(n,e);}}})(n,e);//# sourceMappingURL=custom-element.js.map
...
class ContactCard extends h$2 {
    ...
    static get styles() {
        return r$1`:host{display:block;width:100%;margin:.25em 0}details,div{padding:1em;color:#fff;display:block}`;
    }
    ...
    render() {
        ...
        return T`<details style="background:${color}"><summary @click="${this._handleSummaryClick}">${name}</summary><p style="${i$4(this._summaryStyle())}">${mediumText}</p></details>`;
    }
...
class ContactList extends h$2 {
    ...
    static get styles() {
        return r$1`:host{display:block;position:absolute;top:0;right:0;bottom:0;left:0}lit-virtualizer{height:100%}`
    }
    ...
    _renderContact(contact) {
        return T`<contact-card .contact="${contact}"></contact-card>`;
    }

    render() {
        return T`<lit-virtualizer .layout="${Layout1d}" .items="${this.data}" .renderItem="${this._renderContact}"></lit-virtualizer>`;
    }
}
