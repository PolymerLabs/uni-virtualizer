...
class Layout1dBase {
    ...
    _emitVisibleIndices(first, last) {
        const detail = {
            first: first,
            last: last,
        };
        this.dispatchEvent(new CustomEvent('visibleindiceschange', { detail, bubbles: true, composed: true }));
    }
    /**
    ...
    _updateVisibleIndices() {
        ...
        // this._emitVisibleIndices(firstVisibleIndex, lastVisibleIndex);
    }
