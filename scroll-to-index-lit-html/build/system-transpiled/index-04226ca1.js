    ...
    execute: function () {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  _context2.next = 9;
                  return module.import('./event-target-shim-0bbd13c8.js');
      ...
      */
      ...
      var example = function example(contacts) {
        ...
        return html$1(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["<section style=\"height:100%\">", "</section>"])), scroll({
          items: contacts,
          layout: Layout1d,
          renderItem: function renderItem(_ref) {
            var longText = _ref.longText,
                index = _ref.index;
            return html$1(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<p>", ") ", "</p>"])), index, longText);
          },
