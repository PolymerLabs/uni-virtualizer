...
const example = (contacts, scrollToIndex = null) => T`<section style="height:100%">${scroll({
            items: contacts,
            layout: Layout1d,
            renderItem: ({ longText, index }) => T`<p>${index}) ${longText}</p>`,
...
window.scrollToIndex = (index, position) => {
    V(example(contacts, {index, position}), document.getElementById("container"));
};
