 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const {et:t$3}=Z,d$1=o=>void 0===o.strings,e$4=()=>document.createComment(""),u$1=(o,i,n)=>{var v;const l=o.A.parentNode,r=void 0===i?o.B:i.A;if(void 0===n){const i=l.insertBefore(e$4(),r),v=l.insertBefore(e$4(),r);n=new t$3(i,v,o,o.options);}else {const t=n.B.nextSibling,i=n.M!==o;if(i&&(null===(v=n.Q)||void 0===v||v.call(n,o),n.M=o),t!==r||i){let o=n.A;for(;o!==t;){const t=o.nextSibling;l.insertBefore(o,r),o=t;}}}return n},c$1=(o,t,i=o)=>(o.I(t,i),o),s$5={},f$1=(o,t=s$5)=>o.H=t,a$3=o=>o.H,m$1=o=>{var t;null===(t=o.P)||void 0===t||t.call(o,!1,!0);let i=o.A;const n=o.B.nextSibling;for(;i!==n;){const o=i.nextSibling;i.remove(),i=o;}};

/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const r$2=(i,t)=>{var s,e;const o=i.N;if(void 0===o)return !1;for(const i of o)null===(e=(s=i).O)||void 0===e||e.call(s,t,!1),r$2(i,t);return !0},o$3=i=>{let t,s;do{if(void 0===(t=i.M))break;s=t.N,s.delete(i),i=t;}while(0===(null==s?void 0:s.size))},h$3=i=>{for(let t;t=i.M;i=t){let s=t.N;if(void 0===s)t.N=s=new Set;else if(s.has(i))break;s.add(i),d$2(t);}};function n$5(i){void 0!==this.N?(o$3(this),this.M=i,h$3(this)):this.M=i;}function l$3(i,t=!1,s=0){const e=this.H,h=this.N;if(void 0!==h&&0!==h.size)if(t)if(Array.isArray(e))for(let i=s;i<e.length;i++)r$2(e[i],!1),o$3(e[i]);else null!=e&&(r$2(e,!1),o$3(e));else r$2(this,i);}const d$2=i=>{var t,e,r,o;i.type==t$2.CHILD&&(null!==(t=(r=i).P)&&void 0!==t||(r.P=l$3),null!==(e=(o=i).Q)&&void 0!==e||(o.Q=n$5));};class c$2 extends s$4{constructor(){super(...arguments),this.isConnected=!0,this.ut=w,this.N=void 0;}T(i,t,s){super.T(i,t,s),h$3(this);}O(i,t=!0){this.at(i),t&&(r$2(this,i),o$3(this));}at(t){var s,e;t!==this.isConnected&&(t?(this.isConnected=!0,this.ut!==w&&(this.setValue(this.ut),this.ut=w),null===(s=this.reconnected)||void 0===s||s.call(this)):(this.isConnected=!1,null===(e=this.disconnected)||void 0===e||e.call(this)));}S(i,t){if(!this.isConnected)throw Error(`AsyncDirective ${this.constructor.name} was rendered while its tree was disconnected.`);return super.S(i,t)}setValue(i){if(this.isConnected)if(d$1(this.Σdt))this.Σdt.I(i,this);else {const t=[...this.Σdt.H];t[this.Σct]=i,this.Σdt.I(t,this,0);}else this.ut=i;}disconnected(){}reconnected(){}}
...
const scroll = i$4(ScrollDirective);
...
async function init$1() {
    ...
    try {
        ...
        _ET = (await import('./event-target-shim-5702ee7a.js')).EventTarget;
    }
    return (ET = _ET);
}
...
(async function go() {
    ...
    virtualizer.renderItem = ({ mediumText, index }) =>
        T`<div style="border-top:3px solid #00f;border-bottom:3px dashed red;width:100%">${index}) ${mediumText}</div>`;
