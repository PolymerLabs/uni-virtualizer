            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  _context2.next = 9;
                  return module.import('./event-target-shim-d796925e.js');
                ...
                case 5:
                  ...
                  virtualizer.renderItem = function (_ref) {
                    var mediumText = _ref.mediumText,
                        index = _ref.index;
                    return html(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["<div style=\"border-top:3px solid #00f;border-bottom:3px dashed red;width:100%\">", ") ", "</div>"])), index, mediumText);
                  };
