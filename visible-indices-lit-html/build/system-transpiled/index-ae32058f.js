    ...
    execute: function () {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  _context2.next = 9;
                  return module.import('./event-target-shim-5e0893b6.js');
      ...
      */
      ...
      var example = function example(contacts) {
        return html$1(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["<section @visibilityChanged=\"", "\" style=\"height:100%\">", "</section>"])), handleVisibilityChange, scroll({
          items: contacts,
          layout: Layout1d,
          renderItem: function renderItem(_ref) {
            var mediumText = _ref.mediumText,
                index = _ref.index;
            return html$1(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<div style=\"border-top:3px solid #00f;border-bottom:3px dashed red;width:100%\">", ") ", "</div>"])), index, mediumText);
          },
          useShadowDOM: true
        }));
      };
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 4:
                  ...
                  render$2(example(contacts), container);
