  ...
  return {
    execute: function () {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  _context2.next = 9;
                  return module.import('./event-target-shim-ce88141b.js');
      ...
      var example = function example(contacts) {
        return T(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["<section @rangeChanged=\"", "\" style=\"height:100%\">", "</section>"])), handleVisibilityChange, scroll({
          items: contacts,
          layout: Layout1d,
