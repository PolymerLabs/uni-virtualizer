  ...
  return {
    execute: function () {
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  _context2.next = 9;
                  return module.import('./event-target-shim-9911f4dc.js');
      ...
      var example = function example(contacts) {
        return html(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["<section>", "</section>"])), scroll({
          items: contacts,
          renderItem: function renderItem(_ref) {
            var mediumText = _ref.mediumText;
            return html(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<p>", "</p>"])), mediumText);
          },
          layout: Layout1d,
          scrollTarget: window
        }));
